...
bootpack.hrb: bootpack.c bootpack.h graphic.c dsctbl.c int.c keyboard.c mouse.c fifo.c har.ld sprintf.c hankaku.c func.o Makefile
	gcc -fno-pie -march=i486 -m32 -nostdlib -T har.ld bootpack.c graphic.c dsctbl.c int.c keyboard.c mouse.c fifo.c sprintf.c hankaku.c func.o -o bootpack.hrb
