...
bootpack.hrb: bootpack.c bootpack.h graphic.c dsctbl.c int.c keyboard.c mouse.c fifo.c memory.c sheet.c har.lds sprintf.c hankaku.c func.o Makefile
	gcc -fno-pie -march=i486 -m32 -masm=intel -nostdlib -T har.lds bootpack.c graphic.c dsctbl.c int.c keyboard.c mouse.c fifo.c memory.c sheet.c sprintf.c hankaku.c func.o -o bootpack.hrb
